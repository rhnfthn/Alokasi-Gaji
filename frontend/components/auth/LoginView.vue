      ...
      <div class="w-full rounded-3xl border border-white/70 bg-white/85 p-6 shadow-[0_20px_60px_-20px_rgba(15,23,42,0.35)] backdrop-blur md:p-8">
        <div class="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-slate-900 text-white shadow-md">
          <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8 7h8v10H8z" />
            <path stroke-linecap="round" stroke-linejoin="round" d="M10 12h7" />
            <path stroke-linecap="round" stroke-linejoin="round" d="m14 9 3 3-3 3" />
          </svg>
        </div>

        <h1 class="text-center text-2xl font-semibold tracking-tight text-slate-900">Sign in with email</h1>
        <p class="mt-2 text-center text-sm text-slate-500">Make your finance tracking smooth and focused.</p>
        ...
        <form class="mt-7 space-y-4" @submit.prevent="onSubmit">
          ...
          <div class="relative">
            ...
            <input
              ...
              class="h-11 w-full rounded-xl border border-slate-200 bg-white/95 pl-10 pr-10 text-sm text-slate-800 placeholder-slate-400 outline-none ring-0 transition focus:border-slate-400"
            />
            <button
              type="button"
          ...
          <div class="flex justify-end">
            <NuxtLink to="/auth/forgot-password" class="text-xs font-medium text-slate-500 transition hover:text-slate-800">Forgot password?</NuxtLink>
          </div>
        ...
        <p class="mt-5 text-center text-sm text-slate-500">
          Belum punya akun?
          <NuxtLink to="/auth/register" class="font-semibold text-slate-800 hover:underline">Sign up</NuxtLink>
        </p>
      </div>
    </div>
  </div>
